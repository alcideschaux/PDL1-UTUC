---
title: PDL1 positivity, median 5%
...
data$outcome <- data$PDL1_pos_5_median
```
...
ggplot(data, aes(x = gender, fill = outcome)) +
  ...
  annotate("text", x = 1.5, y = 65, label = paste("P value =", p)) +
...
ggplot(data, aes(x = location, fill = outcome)) +
  ...
  annotate("text", x = 2, y = 50, label = paste("P value =", p)) +
...
ggplot(data, aes(x = pt, fill = outcome)) +
  geom_bar(position = position_dodge(), color = "black") +
  scale_y_continuous(limits = c(0, 50), breaks = seq(0, 50, 10)) +
  annotate("text", x = 3, y = 50, label = paste("P value =", p)) +
...
ggplot(data, aes(x = high_grade, fill = outcome)) +
  ...
  annotate("text", x = 1.5, y = 85, label = paste("P value =", p)) +
...
ggplot(data_nona, aes(x = progression, fill = outcome)) +
  geom_bar(position = position_dodge(), color = "black") +
  scale_y_continuous(limits = c(0, 50), breaks = seq(0, 50, 10)) +
  annotate("text", x = 1.5, y = 50, label = paste("P value =", p)) +
...
ggplot(data, aes(x = dod, fill = outcome)) +
  ...
  annotate("text", x = 1.5, y = 70, label = paste("P value =", p)) +
...
with(data, gsurv(fu_mo, dod, outcome)) +
  ...
  annotate("text", label = paste("P value =", p), x = 25, y = .35) +
