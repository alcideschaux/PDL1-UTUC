...
data_PDL1_tumor <- data1 %>%
  ...
  mutate(
    PDL1_pos_1_median = ifelse(PDL1_median > 1, "Yes", "No"),
    PDL1_pos_1_max = ifelse(PDL1_max > 1, "Yes", "No"),
    PDL1_pos_5_median = ifelse(PDL1_median > 5, "Yes", "No"),
    PDL1_pos_5_max = ifelse(PDL1_max > 5, "Yes", "No")
  )
